...
class TableDiffFormatter extends DiffFormatter
{
  function TableDiffFormatter() {
    $this->leading_context_lines = 99;
    $this->trailing_context_lines = 99;
  }
  ...
  function _block_header( $xbeg, $xlen, $ybeg, $ylen ) {
    ...
    $l1 = $lang['line'].' '.$xbeg;
    $l2 = $lang['line'].' '.$ybeg;
    $r = '<tr><td class="diff-blockheader" colspan="2" style="border-bottom: 1px dashed gray;">'.$l1.":</td>\n" .
      '<td class="diff-blockheader" colspan="2" style="border-bottom: 1px dashed gray;">'.$l2.":</td></tr>\n";
    return $r;
  }
  ...
  function deletedLine( $line ) {
    $line = str_replace('  ','&nbsp; ',$line);
    return '<td>-</td><td class="diff-deletedline" style="border-right: 1px dashed gray;">' .
      $line.'</td>';
  }

  function emptyLine() {
    //$line = str_replace('  ','&nbsp; ',$line);
    return '<td colspan="2" style="border-bottom: 1px dashed gray;">&nbsp;</td>';
  }

  function contextLine( $line ) {
    $line = str_replace('  ','&nbsp; ',$line);
    return '<td> </td><td class="diff-context" style="border-right: 1px dashed gray;">'.$line.'</td>';
  }
