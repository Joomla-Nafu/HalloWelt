...
if( ! is_dir(JPATH_ROOT.DS.'sources'.DS.'joomla'))
{
...
case 'source':
    ...
    break;
		...
		?> <a id="permaLink" id="permaLink" href="<?php echo ($path) ? '' : '#'; ?>">Perma link</a></div>
...
<div style="float: left; text-align: left;"><strong
	style="color: orange">Please</strong> report any errors <a
	href="http://forum.easy-joomla.org/" class="external">here</a> <br />
...
<div style="float: right;"><small><strong style="color: red;">Oh...</strong>
if you like, you can also<br />
<a class="jfd_dl" href="jfdoc_090720.zip">download this thingy</a></small></div>
<div style="clear: both;"></div>
</div>
